		...
		$(".cancelBtn")
				.click(
						function() {
							...
							var checkedNum = $(this).parents("tr").attr(
									"data-num");
							var cancelTrBook_date = $(this).parents("td")
									.siblings(".memberSeatDate").attr(
											"data-value");
							var cancelTrPayDate = $(this).parents("td")
									.siblings(".memberPayDate").attr(
											"data-value");
							var totalPayValue = $(this).parents("td").siblings(
									".memberTotalPay").attr("data-value");
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="f_Form">
						...
						<div align="center">
						<p><strong>※ 예약 취소 환불 규정 ※</strong></p>
						<p>예약일자로 부터 6 ~ 4일전 예약 취소시 결제금액 기준 10% 공제</p>
						<p>예약일자로 부터 3 ~ 2일전 예약 취소시 결제금액 기준 20% 공제</p>
						<p>예약일자로 부터 하루전 예약 취소시 결제금액 기준 30% 공제</p>
						<p>단, 결제당일 예약 취소시 전액 환불가능</p><hr>
						<p><font size="2.5px">* 예약취소를 하시게되면, 예약할때 지급받았던 포인트는 삭감처리 되는점 양해 부탁드립니다.</font></p>
						<p></p>
