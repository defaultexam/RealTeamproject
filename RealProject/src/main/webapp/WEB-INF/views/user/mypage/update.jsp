		...
		<form id="update">
			...
			<div>
				<label>비밀번호</label> <input type="password" id="password"
					style="width: 250px;" class="form-control" name="password">
				<label>비밀번호 확인</label> <input type="password" id="repassword"
					class="form-control" style="width: 250px;" onblur="passwordCheck()">
			</div>
			...
			<div class="form-inline">
				<label>이메일</label> <input type="text" id="email1" name="email1"
					style="width: 200px;" class="form-control" placeholder=""
					required="required"> <label for="email2">@</label> <input
					type="text" id="email2" name="email2" style="width: 200px;"
			...
			<div>
				<label>전화번호</label> <input type="text" name="phone"
					class="form-control" style="width: 170px;" value="${update.phone }">
			</div>
			...
			<div class="input-group">
				...
				<div class="input-group">
					<input type="text" class="form-control" name="postcode"
						...
						style="width: 500px;" style="z-index: 0;" readonly="readonly">
			...
			<div>
				<label>결혼기념일</label> <input type="text" required
					...
					class="form-control" style="width: 250px;" name="weddingdate"
					value="${update.weddingdate.toString().substring(0,10) }">
				<c:if test="${update.weddingdate == '9999-12-31'}">
					<script type="text/javascript">
						$("#weddingdate").val("");
			...
			<!-- 직업 -->
			<div>
				<label>직업</label> <input type="text" name="job" class="form-control"
					style="width: 250px;" value="${update.job }">
			</div>
			<br />
			<div align="center">
				<input type="button" id="updateBtn" value="수정"
					class="btn btn-default"> <input type="button"
					id="updateCancel" value="취소" class="btn btn-default">
			</div>
