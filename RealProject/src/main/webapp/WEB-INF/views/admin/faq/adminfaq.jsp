					...
					if (!formCheck($('#faq_title'),
						...
						$.ajax({
							...
							data : {
								...
								"faq_text" : $("#faq_text").val(),
								"faq_type" : $("#faq_type").val()
							},
							dataType : "text",
							error : function() {
			...
			function() {
				...
				if (!formCheck($('#updatefaq_title'),
					...
					$.ajax({
						...
						data : {
							"faq_title" : $("#updatefaq_title").val(),
							"faq_text" : $("#updatefaq_text").val(),
							"faq_type" : $("#updatefaq_type").val(),
							...
							<div class="panel panel-default" style="width: 100%;"
								...
								<div class="panel-heading" role="tab"
									...
									<label style="padding-left: 10%; float: left;">
										${faq.faq_type}</label>
									<!-- 제목 출력 -->
									<label style="padding-left: 10%;"> ${faq.faq_title} </label>
									<!-- 날짜출력 -->
